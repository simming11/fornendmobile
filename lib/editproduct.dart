...
class _EditProductState extends State<EditProduct> {
  ...
  Future<void> _fetchProductDetails(int productId) async {
    ...
    var url = Uri.parse('https://642021164.pungpingcoding.online/api/products/$productId');
  ...
  Future<void> _submitFormData() async {
    ...
    var url = Uri.parse('https://642021164.pungpingcoding.online/api/products/${widget.productId}');
