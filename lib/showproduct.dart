...
class _ShowProductPageState extends State<ShowProductPage> {
  ...
  Future<void> _fetchProducts() async {
    ...
    var url = Uri.parse('https://642021164.pungpingcoding.online/api/product');
  ...
  Future<void> _deleteProduct(int id) async {
    var url =
        Uri.parse('https://642021164.pungpingcoding.online/api/products/$id');
  ...
  Future<void> _logout() async {
    ...
    var logoutUrl =
        Uri.parse('https://642021164.pungpingcoding.online/api/logout');
